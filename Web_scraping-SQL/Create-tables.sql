...
FROM '/var/opt/mssql/sql_files/jornada25/index_equipo_posicion_normalizado.txt'
WITH
(
...
FROM '/var/opt/mssql/sql_files/jornada25/clasic_stats_normalizado.txt'
WITH
(
...
FROM '/var/opt/mssql/sql_files/jornada25/eficiencia_stats_normalizado.txt'
WITH
(
    DATAFILETYPE = 'char', -- Corregir tipo de archivo de datos
    FIELDTERMINATOR = ';',
...
FROM '/var/opt/mssql/sql_files/jornada25/disciplina_stats_normalizado.txt'
WITH
(
    DATAFILETYPE = 'char', -- Corregir tipo de archivo de datos
    FIELDTERMINATOR = ';',
...
FROM '/var/opt/mssql/sql_files/jornada25/ataques_stats_normalizado.txt'
WITH
(
    DATAFILETYPE = 'char', -- Corregir tipo de archivo de datos
    FIELDTERMINATOR = ';',
...
FROM '/var/opt/mssql/sql_files/jornada25/defensivas_stats_normalizado.txt'
WITH
(
    DATAFILETYPE = 'char', -- Corregir tipo de archivo de datos
    FIELDTERMINATOR = ';',
